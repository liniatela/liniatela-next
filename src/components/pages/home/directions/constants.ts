...
export const MOCK_DIRECTIONS: Direction[] = [
  {
    id: '1',
    shortDescription:
      'Техника самомассажа. Освобождает мышцы от зажимов, улучшает кровообращение и запускает лимфоток',
    name: 'МФР',
  ...
  },
  {
    id: '7',
    shortDescription:
      'Танец, где женственность встречается с энергией. Пластика, сила и свобода движений раскрывают вашу внутреннюю магию.',
    name: 'Танец свободы',
    category: 'Танцы',
    slug: 'tanec-svobody',
    fullDescription:
