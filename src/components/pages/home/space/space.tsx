...
function Space() {
	return (
		<section className='space -mt-7 pt-20 overflow-hidden select-none'>
						...
						<div className='grid sm:grid-rows-[1fr_240px] gap-1'>
							<div className='relative overflow-hidden rounded-3xl p-6 text-white'>
								<h3 className='text-lg lg:text-2xl leading-none tracking-tighter'>
									Тёплое, светлое и камерное пространство, где ты можешь замедлиться, переключиться
		...
		<article className='group relative rounded-3xl overflow-hidden aspect-video shadow-lg'>
			...
			<div className='relative z-20 p-6 h-full flex flex-col'>
				<div className='space-y-4'>
					<div>
						<h4 className='text-white text-2xl sm:text-3xl mb-2 leading-none tracking-tighter'>{hall.name}</h4>
						<p className='max-sm:hidden text-border text-sm leading-none tracking-tighter'>{hall.description}</p>
					</div>
				</div>
			</div>
